/* linux/drivers/video/msm/mddi_tc358723xbg.c
 *
...
/*< BK4D01218 : LCD screen splitted issue , liangzonglian l00149187, 20090711, end>  */
/* BK4D02211 : screen flicker issue when sleep/wakeup, Liangzonglian 00149187, 2009/07/16, end */

/* BK4D02211 : screen flicker issue when sleep/wakeup, Liangzonglian 00149187, 2009/07/16, start */
/*< BK4D00405 : PM for mddi/mddi2rgb/panel , liangzonglian l00149187, 20090521, start>  */
/*<  BK4D04170: remove suspend/resume and add them to on/off , liangzonglian l00149187, 20090819, start>	*/
#if 0
...
#endif
#endif
/*<  BK4D04170: remove suspend/resume and add them to on/off , liangzonglian l00149187, 20090819, end>	*/
/* BK4D02211 : screen flicker issue when sleep/wakeup, Liangzonglian 00149187, 2009/07/16, end */

/*< BK4D00405 : PM for mddi/mddi2rgb/panel , liangzonglian l00149187, 20090521, end>  */

static void mddi_tc358723xbg_reset(void)
{
	// reset
	/*< BK4D04421 : LCD black screen after sleep/wakeup, liangzonglian l00149187, 20090825, start>  */
	s_panel_state = E_STATE_STANDBY;
	tc358723xbg_state = TC358723_STATE_PRIM_SEC_STANDBY;
	/*< BK4D04421 : LCD black screen after sleep/wakeup, liangzonglian l00149187, 20090825, end>  */
...
/*< BK4D01218 : LCD screen splitted issue , liangzonglian l00149187, 20090711, start>  */

/*< BK4D02089 : T2'LCD2V8 can be captatible of PP1'LCD3P3   , zhangzhen  z00131051, 20090629, start>  */
#ifdef CONFIG_HUAWEI_FEATURE_U8220_PP1
	gpio_tlmm_config(GPIO_CFG
	(19, 0, GPIO_OUTPUT,
	...
	GPIO_ENABLE);
#endif
/*< BK4D02089 : T2'LCD2V8 can be captatible of PP1'LCD3P3   , zhangzhen  z00131051, 20090629, end>  */

/*BK4D04578 , set gpio 41 ownership, jialin, 20090908, begine*/
	gpio_tlmm_config(GPIO_CFG
	(41, 0, GPIO_OUTPUT,
	GPIO_NO_PULL, GPIO_2MA),
	GPIO_ENABLE);
/*BK4D04578 , set gpio 41 ownership, jialin, 20090908, end*/
...
#ifdef CONFIG_FB_MSM_MDDI_AUTO_DETECT
{
	...
	if (!ret) {
		...
		pinfo->wait_cycle = 0;
		/*< BK4D00296 : LCD 24bit support , liangzonglian l00149187, 20090415, start>  */
		#ifdef CONFIG_HUAWEI_MDDI_LCD_24BIT
		pinfo->bpp = 32;
		#else
		pinfo->bpp = 18;
		#endif
		/*< BK4D00296 : LCD 24bit support , liangzonglian l00149187, 20090415, end>  */
		pinfo->lcd.vsync_enable = TRUE;
		/*pinfo->lcd.refx100 =
		    (mddi_tc358723xbg_rows_per_second * 100) /
		    mddi_tc358723xbg_rows_per_refresh;*/
		/*< BK4D01218 : LCD screen splitted issue , liangzonglian l00149187, 20090711, end>  */
		/*< BK4D02955 : make fresh rate from 60Hz to 75Hz, liangzonglian l00149187, 20090722, start>	*/
		#ifdef M_SWITCH_REFRESH_RATE
		...
		#endif
		/*< BK4D02955 : make fresh rate from 60Hz to 75Hz, liangzonglian l00149187, 20090722, end>	*/
		pinfo->fb_num = 2;
		/*< BK4D01218 : LCD screen splitted issue , liangzonglian l00149187, 20090711, end>  */
