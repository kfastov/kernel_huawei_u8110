...
usb_pid_stru usb_pid_array[]={
    {PID_ONLY_CDROM,     PID_NORMAL,     PID_UDISK, PID_AUTH},     
    {PID_ONLY_CDROM_TMO, PID_NORMAL_TMO, PID_UDISK, PID_AUTH_TMO}, 
};
...
#ifdef CONFIG_TOUCHSCREEN_SYNAPTICS_I2C_RMI_TM1458
    {
            I2C_BOARD_INFO("synaptics-tm1458", 0x24),                
...
static void proc_usb_para(void)
{
    ...
    USB_PR("lxy: curr_usb_pid_ptr: 0x%x, 0x%x, 0x%x, 0x%x\n", 
...
/*fastix-usbhost*/
	...
	else if (machine_is_msm7x25_u8150())
                                 ...
                                 struct meminfo *mi)
{
    ...
    USB_PR("lxy: %s,usb_boot_mode=0x%x\n", __func__, usb_boot_mode);
#endif
}
...
lcd_panel_type lcd_panel_probe(void)
{
    ...
    else if(machine_is_msm7x25_u8300())
    {
        ...
        {
            case 0: 
                hw_lcd_panel = LCD_HX8357A_BYD_QVGA;
                break;
            case 1: 
